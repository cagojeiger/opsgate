...
use opsgate_model::credential::{
    Credential, CredentialListParams, InsertCredentialParams, UpdateCredentialParams,
};
...
mod rows;
pub use rows::{CountRow, CredentialSecretMaterial, CredentialSecretRow, CredentialSummaryRows};
use rows::{CredentialRow, target_columns};
